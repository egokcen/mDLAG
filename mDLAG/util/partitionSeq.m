function groupSeq = partitionSeq(seq, dims, varargin)
%
% groupSeq = partitionSeq(seq, dims, varargin)
%
% Description: Partition sequences according to the groups given in dims.
%
% Arguments:
%
%     Required:
