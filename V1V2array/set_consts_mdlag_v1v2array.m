...
% Access results files here
resultFile_mdlag = './mdlag/results/mdlag_107l003p143_stim1.mat';

%% Fitting parameters

xDim_fit = 20;           % Number of latent variables to be fitted
...
maxTauFrac = 0.5;     % Maximum timescale magnitude (unit: fraction of trial length)
...
segLength = 32;       % Optional speedup to cut trials into smaller segments during fitting
